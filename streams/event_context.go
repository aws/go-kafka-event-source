...
// any pertinent data needed for processing. If you are using [AsyncBatchScheduler] or [AsyncJobScheduler], you should not need to interact with this method directly.
