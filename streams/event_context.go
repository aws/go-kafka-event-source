...
// any pertinent data needed for processing. If you are using [AsyncBatcher], [AsyncJobScheduler] or [BatchProducer], you should not need to interact with this method directly.
